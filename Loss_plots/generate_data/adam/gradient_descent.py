...
class GradientDescent(Optimizer):
    ...
    For a function :math:`f` and an initial np.ndarray :math:`\vec\theta_0`, the standard (or "vanilla")
    ...
    Examples:
        ...
        .. code-block::python
            ...
            initial_np.ndarray = np.array([1, 0.5, -0.2])
            optimizer = GradientDescent(maxiter=100)
            x_opt, fx_opt, nfevs = optimizer.optimize(initial_np.ndarray.size,
                                                      f,
                                                      initial_np.ndarray=initial_np.ndarray)
    ...
    ) -> Tuple[np.ndarray, float, np.int32]:
        # set learning rate
